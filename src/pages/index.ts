...
export { default as SupervisorDashboard } from '../modules/dashboard/pages/SupervisorDashboard';
...
export { default as OrganizationPage } from '../modules/organization/pages/OrganizationPage';

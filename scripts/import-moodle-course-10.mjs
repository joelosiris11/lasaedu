#!/usr/bin/env node
/**
 * Import Moodle course id=10  →  "Electrónica Básica - Segunda Generación"
 * →  lasaedu mdl_course_10
 *
 * Usage:
 *   GOOGLE_APPLICATION_CREDENTIALS=~/keys/lasaedurd-sa.json \
 *   FILE_SERVER_URL=https://files.lasaedu.cloudteco.com \
 *   node scripts/import-moodle-course-10.mjs [--dry-run]
 *
...
importMoodle({ courseIds: [10], dryRun }).catch((err) => {
